...
#         print("Visualização gráfica salva como 'arvore_binaria.png'.")
...
class ArvoreBinaria:
    ...
    def visualizar_graphviz(self, nome_arquivo='arvore_binaria'):
        dot = graphviz.Digraph()
        self._add_nos_ao_dot(self.raiz, dot)
        dot.render(nome_arquivo, format='png', cleanup=True)
        print(f"Visualização gráfica salva como '{nome_arquivo}.png'.")
...
# ---------- PARTE 1: Árvore com Valores Fixos ----------
print("="*40)
...
print("\nVisualização da Árvore Fixa (Texto):")
arvore_fixa.visualizar_texto()

arvore_fixa.visualizar_graphviz('arvore_fixa')

print("\nTravessia Inorder:")
print(arvore_fixa.inorder())

print("Travessia Preorder:")
print(arvore_fixa.preorder())

print("Travessia Postorder:")
print(arvore_fixa.postorder())

# ---------- PARTE 2: Árvore com Valores Randômicos ----------
print("\n" + "="*40)
print("ÁRVORE COM VALORES RANDÔMICOS")

valores_aleatorios = random.sample(range(1, 100), 10)
print(f"\nValores gerados aleatoriamente: {valores_aleatorios}")

arvore_random = ArvoreBinaria()
for v in valores_aleatorios:
    arvore_random.inserir(v)

print("\nVisualização da Árvore Aleatória (Texto):")
arvore_random.visualizar_texto()

arvore_random.visualizar_graphviz('arvore_aleatoria')

print("\nTravessia Inorder:")
print(arvore_random.inorder())

print("Travessia Preorder:")
print(arvore_random.preorder())

print("Travessia Postorder:")
print(arvore_random.postorder())
